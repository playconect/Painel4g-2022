...
apt install php5 libapache2-mod-php5 php5-mcrypt -y > /dev/null 2>&1
systemctl restart apache2 > /dev/null 2>&1
echo ""
...
apt install phpmyadmin -y > /dev/null 2>&1
php5enmod mcrypt > /dev/null 2>&1
systemctl restart apache2 > /dev/null 2>&1
apt install libssh2-1-dev libssh2-php -y > /dev/null 2>&1
php -m |grep ssh2 > /dev/null 2>&1
apt install php5-curl -y > /dev/null 2>&1
systemctl restart apache2 > /dev/null 2>&1
