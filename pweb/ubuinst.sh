...
echo -e ""
echo -e "\e[1;97m           \e[5m\033[1;100m   INSTALADOR PAINEL WEB 4G ⚡   \033[1;37m"
...
sleep 1
if [[ -e "/var/www/html/conexao.php" ]]; then
sed -i "s;suasenha;$pwdroot;g" /var/www/html/conexao.php > /dev/null 2>&1
fi
sleep 1
cd || exit
...
if [[ -e "$HOME/net.sql" ]]; then
    mysql -h localhost -u root -p"$pwdroot" --default_character_set utf8 net < net.sql
    rm /root/net.sql
else
    clear
    echo -e "\033[1;31m ERRO CRÍTICO\033[0m"
